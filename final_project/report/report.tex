...
\begin{abstract}
    ...
    meaningful features from classifiers that analyzed shared and different words.
    Data was filtered strategically to remove noise, fed into thesel classifiers,
    and combined with a logistic regression model. Through this ensemble approach, we
    achieved 0.41 log-loss on our training data and 0.35 log-loss on our testing data.
\end{abstract}
...
question mark included. In order to maintain this unexpected benefit without
further complicating our classifier, we decided to remove all punctuation except
for question marks. This gave us the lowest log-loss of all three
configurations.
