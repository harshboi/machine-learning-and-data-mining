...
while still taking adveantage of the gains provided by stripping punctuation, we
...
misspellings in the dataset. To remedy this, we explored the idea of using a
...
decided to use Google's pretrained model rather than training our own due to the
...
worried that a more complex model would overfit, and were unsure of our ability
...
giving TF-IDF pairs of words, but these yeilded either no net improvement or
...
dramatic imrpovements attained with simple steps like removing punctuation.
...
structure, like a nueral network, this could increase performance.
